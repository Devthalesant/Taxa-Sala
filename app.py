...
# Inputs
aluguel = st.number_input("Qual o valor do seu aluguel? (R$)", min_value=1, step=0.01)
funcionarios = st.number_input("Qual o gasto total com funcionarios? (R$)", min_value=1, step=0.01)
demais = st.number_input("Qual o valor total com demais gastos? (R$)", min_value=1, step=0.01)
